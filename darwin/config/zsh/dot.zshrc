...
# Suppress "[WARNING]: Console output during zsh initialization detected." message.
...
# Custom completions (e.g. Bitwarden cached completion)
if [[ ! -f ~/.zfunc/_bw ]] && (( $+commands[bw] )); then
  mkdir -p ~/.zfunc
  bw completion --shell zsh > ~/.zfunc/_bw 2>/dev/null
fi
fpath=(~/.zfunc $fpath)
...
plugins=(git extract azure terraform docker zsh-autosuggestions zsh-syntax-highlighting)
...
# ••• fzf •••
# ==========================================
source <(fzf --zsh --input-border=rounded)
...
export PATH="/Users/me/.antigravity-ide/antigravity-ide/bin:$PATH"
...
# ==========================================
# CUSTOM FUNCTIONS: Kanata Management
# ==========================================
# Custom functions
function kanatactl() {
      local service="com.kanata.service"
